...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tipousuario.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ADMINISTRADOR", "VENDEDOR", "OTROS" }));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(tipousuario, 0, 123, Short.MAX_VALUE)
    ...
    public void ocultar(){
        if(tipousuario.getSelectedItem().equals("ADMINISTRADOR")){
            ...
            if(tipousuario.getSelectedItem().equals("VENDEDOR")){
            MENU m=new MENU();
            ...
            m.show();
                ...
                if(tipousuario.getSelectedItem().equals("OTROS")){
            MENU m=new MENU();
            m.usuarios.setVisible(false);
            m.inventario.setVisible(false);
            m.almacen.setVisible(false);
            m.reportes.setVisible(false);
            m.show();
        }
        }
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String con=txt_contraseña.getText();
        
        if(usu.equals("JHON") && con.equals("1234")){
            MENU m = new MENU();
